...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two strings as the arguments and sets the name
     * of this instance to the concatenation of the two strings.
     *
     * @param string1 the string that goes first in the name.
     * @param string2 the string that goes second in the name.
     */
